        ...
        : data && (
            <div className="container mx-auto mt-8 p-4  rounded-lg shadow-md">
              ...
              <div
                ...
                style={{
                  backgroundImage: `url(${data.coverPic ? `/uploads/posts/${data.coverPic}` : "https://via.placeholder.com/800x400"})`,
              ...
              >
                <div className="flex items-center justify-center h-full p-4">
                  <img src={data.profilePic ? `/uploads/posts/${data.profilePic}` : "https://via.placeholder.com/80"}
alt="Profile Picture"
